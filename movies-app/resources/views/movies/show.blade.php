...
@section('content')
    <div class="movie-info border-b border-gray-800 py-8 px-16">
        <div class="container mx-auto py-6 flex">
            ...
            <div class="ml-24 w-4/6">
                ...
                <div class="flex items-center text-gray-400 text-sm mt-1">
                    <span><svg class="fill-current text-yellow-500 w-4" aria-hidden="true" focusable="false"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                @foreach ($movie['images']['backdrops'] as $image)
                    @if ($loop->index < 6)
                        <div class="mt-8">
                            <a href="#">
                                <img src="{{ 'https://image.tmdb.org/t/p/w500/' . $image['file_path'] }}" alt="ups"
                                    class="hover:opacity-75 transition ease-in-out duration-150">
                            </a>
                        </div>
                    @endif
